...
#include "/home/estatuadetamal/.cache/wal/colors-wal-dwm.h"
...
static char *colors[][ColCount] = {
	/*                       fg                bg                border                float */
	[SchemeNorm]         = { norm_fg,  norm_bg,  norm_border,  norm_border},
	[SchemeSel]          = { sel_fg,   sel_bg,   sel_bg /*sel_border*/,       sel_border},
	[SchemeTitleNorm]    = { titlenormfgcolor, titlenormbgcolor, titlenormbordercolor, titlenormfloatcolor },
	[SchemeTitleSel]     = { sel_fg,  sel_bg,  titleselbordercolor,  titleselfloatcolor },
	[SchemeTagsNorm]     = { tagsnormfgcolor,  tagsnormbgcolor,  tagsnormbordercolor,  tagsnormfloatcolor },
	[SchemeTagsSel]      = { sel_fg,  sel_bg,   tagsselbordercolor,   tagsselfloatcolor },
	[SchemeHidNorm]      = { hidnormfgcolor,   hidnormbgcolor,   c000000,              c000000 },
	[SchemeHidSel]       = { hidselfgcolor,    hidselbgcolor,    c000000,              c000000 },
	[SchemeUrg]          = { urg_fg,       urg_bg,       urg_border,  urg_border},
	#if RENAMED_SCRATCHPADS_PATCH
...
static const Key keys[] = {
	...
	/*MY COMMANDS*/
        ...
        { MODKEY,   XK_F9, spawn,	SHCMD("dmenuunmount") },
        { MODKEY,   XK_F10, spawn,	SHCMD("displayselect") },
        { 0,      XK_Print,                spawn,	SHCMD("flameshot gui")},
        { 0,      XF86XK_AudioRaiseVolume, spawn,	SHCMD("pamixer -i 3 && volume.sh") },
        { 0,      XF86XK_AudioLowerVolume, spawn,	SHCMD("pamixer -d 3 && volume.sh") },
        { 0,      XF86XK_AudioMute, 	   spawn,	SHCMD("pamixer -t && volume.sh") },
       // { 0,      XF86XK_MonBrightnessUp,  spawn,	SHCMD("pkexec /usr/bin/brillo -A 1")},
        //{ 0,      XF86XK_MonBrightnessDown,spawn,	SHCMD("pkexec /usr/bin/brillo -U 1")},
        ...
        { Mod1Mask,          XK_Up,	   spawn,       SHCMD("pamixer -i 5 && volume.sh") },
        { Mod1Mask,          XK_Down,      spawn,       SHCMD("pamixer -d 5 && volume.sh") },
        { Mod1Mask,          XK_Left,      spawn,       SHCMD("pkexec /usr/bin/brillo -U 1")},
        { Mod1Mask,          XK_Right,     spawn,       SHCMD("pkexec /usr/bin/brillo -A 1")},
       // { Mod1Mask,          XK_Left,      spawn,       SHCMD("brightness.sh up")},
       // { Mod1Mask,          XK_Right,     spawn,       SHCMD("brightness.sh down")},
        { Mod1Mask,          XK_d,	   spawn,       SHCMD("cmus-remote -k -5")},
        { Mod1Mask,          XK_f,	   spawn,       SHCMD("cmus-remote -k +5")},
        { Mod1Mask,          XK_c,	   spawn,       SHCMD("cmus-remote -u")},
        { Mod1Mask,          XK_b,	   spawn,       SHCMD("cmus-remote -n")},
        { Mod1Mask,          XK_z,	   spawn,       SHCMD("cmus-remote -r")},
        { MODKEY,            XK_m,	   spawn,       SHCMD("mic.sh")},
        { MODKEY|ShiftMask,   XK_m,	   spawn,       SHCMD("isHDDon_cmus")},
        { MODKEY|ControlMask,   XK_h,	   spawn,       SHCMD("prime-run HEAVYPAINT.x86_64")},
	{ MODKEY,            XK_c,         spawn,	SHCMD("config")},
	/*{ MODKEY,            XK_Return,    zoom,        {0} },*/
	{ MODKEY,            XK_u,         spawn,       {.v = termcmd } },
	{ MODKEY,            XK_r,         zoom,        {0} },
	{ MODKEY,            XK_q,         killclient,  {0} },
	{ MODKEY,            XK_p,         spawn,       {.v = dmenucmd } },
	{ MODKEY,            XK_i,         spawn,       {.v = qutecmd } },
	{ Mod1Mask,          XK_y,         incnmaster,  {.i = +1 } },
	{ Mod1Mask,          XK_t,         incnmaster,  {.i = -1 } },
